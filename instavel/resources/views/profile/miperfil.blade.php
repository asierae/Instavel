...
<head>
  ...
  <title>Perfil de {{ Auth::user()->nickname }}</title>
...
<body style="background-image: url(/images/images_profile/main_background.png)">
  ...
  <header class="w3-display-container w3-content" style="max-width:100%">
    <?php $url='/images/'.Auth::user()->nickname.'/photographer.jpg'?>
    <img src="{{ $url }}" height="350" width="100%">
    <div class="w3-display-middle w3-padding-xlarge w3-border w3-wide w3-text-light-grey w3-center">
      <h1 class="w3-hide-medium w3-hide-small w3-xxxlarge"> {{ Auth::user()->nickname }}</h1>
      <h5 class="w3-hide-large" style="white-space:nowrap"> {{ Auth::user()->nickname }}</h5>
      <h3 class="w3-hide-medium w3-hide-small">{{Auth::user()->cita}}</h3>
      <?php $url2='/images/'.Auth::user()->nickname.'/avatar.jpg'?>
      <img class="w3-image" src="{{ $url2 }}" alt="{{Auth::user()->name}}" style="border-radius: 50%;box-shadow: 0 0 8px rgba(0, 0, 0, .8); height: 110px; width: 110px;" height="110" width="110">
    </div>

    <!-- Navbar (placed at the bottom of the header image) -->
    <ul class="w3-navbar w3-light-grey w3-round w3-display-bottommiddle w3-hide-small" style="bottom:-16px">
      <li><a style="color: black;" href="/perfil">Álbum</a></li>
      <li><a style="color: black;" href="/uploader">Publicar Fotos</a></li>
      <li><a style="color: black;" href="/search">Buscar Fotos</a></li>
      <li><a style="color: black;" href="/info">Información personal</a></li>
      <li><a style="color: black;" href="/friends">Amigos</a></li>
      <li><a style="color: black;" href="/news">Actividad</a></li>
    </ul>
  </header>
  ...
  <ul class="w3-navbar w3-light-grey w3-hide-large w3-hide-medium">
    <li><a style="color: black;" href="/perfil">Álbum</a></li>
    <li><a style="color: black;" href="/upload_single">Subir Foto</a></li>
    <li><a style="color: black;" href="/upload">Subir Álbum</a></li>
    <li><a style="color: black;" href="/perfil/info">Información personal</a></li>
    <li><a style="color: black;" href="/friends">Amigos</a></li>
    <li><a style="color: black;" href="/news">Novedades</a></li>
  </ul>
